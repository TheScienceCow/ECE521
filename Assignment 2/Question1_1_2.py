...
with np.load("notMNIST.npz") as data :
    ...
    plt.title('Logistic Regression Accuracy with LR = 0.001 and Adam Optimizer')
    plt.legend()
    plt.show()
    ...
    plt.xlabel('Number of Epochs')
    plt.title('Logistic Regression Cross Entropy Loss with LR = 0.001 and Adam Optimizer')
    plt.legend()
    plt.show()
